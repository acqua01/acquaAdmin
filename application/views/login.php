		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="well span5 center login-box">
					...
					<form class="form-horizontal" name="process" action="<?php echo base_url();?>login/process" method="post">
						<fieldset>
							...
							<div class="input-prepend" title="Password" data-rel="tooltip">
								<span class="add-on"><i class="icon-lock"></i></span><input class="input-large span10" name="userid" id="userid" type="password" value="admin123456" />
							</div>
							<div class="clearfix"></div>
